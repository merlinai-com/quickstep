...
| No. | Workstream | Status | Notes |
|-----|------------|--------|-------|
| 0.1 | Fork & rename repo | ✅ Done | Repo lives at `merlinai-com/quickstep` |
| 0.2 | Attribution & docs | ✅ Done | README, AUTHORS, design docs reference Raphael Darley and Hao & Chandramouli |
| 0.3 | Codebase analysis | ✅ Done | `design/codebase-analysis.md` |
...
| 1.3 | Implement split/merge logic | Requires lock escalation + map table updates (coordinate with Raphael where possible) |
